...
import * as import44 from '../services/UsuarioService';
import * as import45 from '@ionic/storage/es2015/storage';
import * as import46 from '../services/user-data';
...
import * as import59 from '../pages/cadastro/cadastro.ngfactory';
import * as import60 from '../pages/esqueceu-senha/esqueceu-senha.ngfactory';
import * as import61 from '../pages/token/token.ngfactory';
import * as import62 from '../pages/tabs/tabs.ngfactory';
import * as import63 from '../pages/feed/feed.ngfactory';
import * as import64 from '../pages/agenda/agenda.ngfactory';
import * as import65 from '../pages/perfil/perfil.ngfactory';
import * as import66 from '../pages/notificacoes/notificacoes.ngfactory';
import * as import67 from '../pages/lista-grupos/lista-grupos.ngfactory';
import * as import68 from '../pages/cadastrar-evento/cadastrar-evento.ngfactory';
import * as import69 from '../pages/evento/evento.ngfactory';
import * as import70 from '../pages/usuario-evento/usuario-evento.ngfactory';
import * as import71 from '../pages/cadastrar-grupo/cadastrar-grupo.ngfactory';
import * as import72 from '../pages/grupo/grupo.ngfactory';
import * as import73 from '../pages/usuario-grupo/usuario-grupo.ngfactory';
import * as import74 from '../pages/editar-perfil/editar-perfil.ngfactory';
import * as import75 from '../pages/perfil-usuario/popover.ngfactory';
import * as import76 from '../pages/perfil-usuario/perfil-usuario.ngfactory';
import * as import77 from '@angular/core/src/application_tokens';
import * as import78 from '@angular/platform-browser/src/dom/events/dom_events';
import * as import79 from '@angular/platform-browser/src/dom/events/key_events';
import * as import80 from '@angular/platform-browser/src/dom/events/hammer_gestures';
import * as import81 from '@angular/core/src/zone/ng_zone';
import * as import82 from '@angular/platform-browser/src/dom/debug/ng_probe';
import * as import83 from './app.component';
...
import * as import88 from 'ionic-angular/platform/query-params';
import * as import89 from 'ionic-angular/platform/platform-registry';
import * as import90 from 'ionic-angular/platform/platform';
import * as import91 from 'ionic-angular/config/config';
import * as import92 from 'ionic-angular/config/mode-registry';
import * as import93 from 'ionic-angular/transitions/transition-registry';
...
import * as import105 from 'ionic-angular/components/app/app-root';
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __DeepLinker_73:any;
  __UsuarioService_74:import44.UsuarioService;
  ...
  constructor(parent:import47.Injector) {
    super(parent,[
      ...
      import59.CadastroPageNgFactory,
      import60.EsqueceuSenhaPageNgFactory,
      import61.TokenPageNgFactory,
      import62.TabsPageNgFactory,
      import63.FeedPageNgFactory,
      import64.AgendaPageNgFactory,
      import65.PerfilPageNgFactory,
      import66.NotificacoesPageNgFactory,
      import67.ListaGruposPageNgFactory,
      import68.CadastrarEventoPageNgFactory,
      import69.EventoPageNgFactory,
      import70.UsuarioEventoPageNgFactory,
      import71.CadastrarGrupoPageNgFactory,
      import72.GrupoPageNgFactory,
      import73.UsuarioGrupoPageNgFactory,
      import74.EditarPerfilPageNgFactory,
      import75.PopoverPageNgFactory,
      import76.PerfilUsuarioPageNgFactory,
      import50.IonicAppNgFactory
    ]
    ,[import50.IonicAppNgFactory]);
  }
  ...
  get _APP_ID_29():any {
    if ((this.__APP_ID_29 == (null as any))) { (this.__APP_ID_29 = import77._appIdRandomProviderFactory()); }
  ...
  get _EVENT_MANAGER_PLUGINS_32():any[] {
    if ((this.__EVENT_MANAGER_PLUGINS_32 == (null as any))) { (this.__EVENT_MANAGER_PLUGINS_32 = [
      new import78.DomEventsPlugin(),
      new import79.KeyEventsPlugin(),
      new import80.HammerGesturesPlugin(this._HAMMER_GESTURE_CONFIG_31)
    ]
    ); }
    return this.__EVENT_MANAGER_PLUGINS_32;
  }
  get _EventManager_33():import16.EventManager {
    if ((this.__EventManager_33 == (null as any))) { (this.__EventManager_33 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_32,this.parent.get(import81.NgZone))); }
  ...
  get _RootRenderer_37():any {
    if ((this.__RootRenderer_37 == (null as any))) { (this.__RootRenderer_37 = import82._createConditionalRootRenderer(this._DomRootRenderer_36,this.parent.get(import82.NgProbeToken,(null as any)))); }
  ...
  get _AppRootToken_53():any {
    if ((this.__AppRootToken_53 == (null as any))) { (this.__AppRootToken_53 = import83.MyApp); }
  ...
  get _Keyboard_60():import33.Keyboard {
    if ((this.__Keyboard_60 == (null as any))) { (this.__Keyboard_60 = new import33.Keyboard(this._Config_21,this._Form_58,this.parent.get(import81.NgZone))); }
  ...
  get _LocationStrategy_62():any {
    if ((this.__LocationStrategy_62 == (null as any))) { (this.__LocationStrategy_62 = import8.provideLocationStrategy(this.parent.get(import84.PlatformLocation),this.parent.get(import85.APP_BASE_HREF,(null as any)),this._Config_21)); }
  ...
  get _TapClick_68():import40.TapClick {
    if ((this.__TapClick_68 == (null as any))) { (this.__TapClick_68 = new import40.TapClick(this._Config_21,this._App_22,this.parent.get(import81.NgZone))); }
  ...
  get _UrlSerializer_72():any {
    if ((this.__UrlSerializer_72 == (null as any))) { (this.__UrlSerializer_72 = import86.setupUrlSerializer(this._DeepLinkConfigToken_54)); }
    return this.__UrlSerializer_72;
  }
  get _DeepLinker_73():any {
    if ((this.__DeepLinker_73 == (null as any))) { (this.__DeepLinker_73 = import87.setupDeepLinker(this._App_22,this._UrlSerializer_72,this._Location_63)); }
    return this.__DeepLinker_73;
  }
  get _UsuarioService_74():import44.UsuarioService {
    if ((this.__UsuarioService_74 == (null as any))) { (this.__UsuarioService_74 = new import44.UsuarioService(this._Http_50)); }
    return this.__UsuarioService_74;
  }
  ...
  createInternal():import1.AppModule {
    ...
    this._QueryParams_14 = import88.setupQueryParams(this._UrlToken_13);
    this._PlatformConfigToken_15 = import89.providePlatformConfigs();
    ...
    this._Platform_20 = import90.setupPlatform(this._PlatformConfigToken_15,this._QueryParams_14,this._UserAgentToken_16,this._NavigatorPlatformToken_17,this._DocumentDirToken_18,this._DocLangToken_19,this.parent.get(import81.NgZone));
    this._Config_21 = import91.setupConfig(this._ConfigToken_12,this._QueryParams_14,this._Platform_20);
    this._App_22 = new import10.App(this._Config_21,this._Platform_20);
    this._APP_INITIALIZER_23 = [
      import92.registerModeConfigs(this._Config_21),
      import93.registerTransitions(this._Config_21),
      import30.setupProvideEvents(this._Platform_20),
      import40.setupTapClick(this._Config_21,this._App_22,this.parent.get(import81.NgZone))
    ]
    ;
    this._ApplicationInitStatus_24 = new import11.ApplicationInitStatus(this._APP_INITIALIZER_23);
    this._Testability_25 = new import12.Testability(this.parent.get(import81.NgZone));
    this._ApplicationRef__26 = new import13.ApplicationRef_(this.parent.get(import81.NgZone),this.parent.get(import94.Console),this,this._ErrorHandler_11,this,this._ApplicationInitStatus_24,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_25);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import95.LOCALE_ID)) { return this._LOCALE_ID_9; }
    if ((token === import9.NgLocalization)) { return this._NgLocalization_10; }
    if ((token === import96.ErrorHandler)) { return this._ErrorHandler_11; }
    if ((token === import91.ConfigToken)) { return this._ConfigToken_12; }
    if ((token === import88.UrlToken)) { return this._UrlToken_13; }
    if ((token === import88.QueryParams)) { return this._QueryParams_14; }
    if ((token === import89.PlatformConfigToken)) { return this._PlatformConfigToken_15; }
    if ((token === import90.UserAgentToken)) { return this._UserAgentToken_16; }
    if ((token === import90.NavigatorPlatformToken)) { return this._NavigatorPlatformToken_17; }
    if ((token === import90.DocumentDirToken)) { return this._DocumentDirToken_18; }
    if ((token === import90.DocLangToken)) { return this._DocLangToken_19; }
    if ((token === import90.Platform)) { return this._Platform_20; }
    if ((token === import91.Config)) { return this._Config_21; }
    ...
    if ((token === import77.APP_ID)) { return this._APP_ID_29; }
    if ((token === import97.DOCUMENT)) { return this._DOCUMENT_30; }
    if ((token === import80.HAMMER_GESTURE_CONFIG)) { return this._HAMMER_GESTURE_CONFIG_31; }
    ...
    if ((token === import98.AnimationDriver)) { return this._AnimationDriver_35; }
    if ((token === import18.DomRootRenderer)) { return this._DomRootRenderer_36; }
    if ((token === import99.RootRenderer)) { return this._RootRenderer_37; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_38; }
    if ((token === import100.Sanitizer)) { return this._Sanitizer_39; }
    if ((token === import20.ViewUtils)) { return this._ViewUtils_40; }
    if ((token === import101.IterableDiffers)) { return this._IterableDiffers_41; }
    if ((token === import102.KeyValueDiffers)) { return this._KeyValueDiffers_42; }
    ...
    if ((token === import105.AppRootToken)) { return this._AppRootToken_53; }
    if ((token === import86.DeepLinkConfigToken)) { return this._DeepLinkConfigToken_54; }
    ...
    if ((token === import85.LocationStrategy)) { return this._LocationStrategy_62; }
    ...
    if ((token === import86.UrlSerializer)) { return this._UrlSerializer_72; }
    if ((token === import87.DeepLinker)) { return this._DeepLinker_73; }
    if ((token === import44.UsuarioService)) { return this._UsuarioService_74; }
